...
import { PdNotifyProps } from "./types/types.js";
import { createNamespace } from "../utils/create.js";
const _withScopeId = (n) => (pushScopeId("data-v-1571383f"), n = n(), popScopeId(), n);
      ...
      return openBlock(), createBlock(Transition, { name: "animate" }, {
        default: withCtx(() => [
          withDirectives(createElementVNode("div", {
            ...
            role: "alert",
            style: normalizeStyle([{ "z-index": "2041" }, { "--pd-notification-width": _ctx.width }]),
