...
const _hoisted_1 = { class: "pd-icon" };
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return vue.openBlock(), vue.createElementBlock("div", _hoisted_1, [
    ...
    _ctx.dot ? (vue.openBlock(), vue.createElementBlock("div", {
      key: 0,
      class: vue.normalizeClass(["pd-info", [_ctx.styleDot, _ctx.bem.e(_ctx.type)]])
    }, vue.toDisplayString(_ctx.badge), 3)) : vue.createCommentVNode("", true)
  ]);
}
const icon = /* @__PURE__ */ _pluginVue_exportHelper(icon_vue_vue_type_script_lang, [["render", _sfc_render], ["__scopeId", "data-v-8ce38e2f"]]);
module.exports = icon;
